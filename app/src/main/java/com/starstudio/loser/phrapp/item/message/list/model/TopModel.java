...
import com.starstudio.loser.phrapp.item.message.list.model.server.TopServer;
...
public class TopModel extends PHRModel implements CommonContract.Model {
    private CommonContract.Presenter mPresenter;

    public TopModel(CommonContract.Presenter presenter) {
        this.mPresenter = presenter;
    }

    @Override
    public Observable<BaseBean> fetchModel(PHRFragment fragment) {
        return TopServer.getInstance(fragment.getContext()).fetchInfo()
