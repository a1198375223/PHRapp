...
import com.starstudio.loser.phrapp.item.message.list.model.server.SportsServer;
...
public class SportsModel extends PHRModel implements CommonContract.Model {
    private CommonContract.Presenter mPresenter;

    public SportsModel(CommonContract.Presenter presenter) {
        this.mPresenter = presenter;
    }

    @Override
    public Observable<BaseBean> fetchModel(PHRFragment fragment) {
        return SportsServer.getInstance(fragment.getContext()).fetchInfo()
