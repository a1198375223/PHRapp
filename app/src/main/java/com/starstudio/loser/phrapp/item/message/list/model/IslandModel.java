...
import com.starstudio.loser.phrapp.item.message.list.model.server.IslandServer;
...
public class IslandModel extends PHRModel implements CommonContract.Model {
    private CommonContract.Presenter mPresenter;

    public IslandModel(CommonContract.Presenter presenter) {
        this.mPresenter = presenter;
    }

    @Override
    public Observable<BaseBean> fetchModel(PHRFragment fragment) {
        return IslandServer.getInstance(fragment.getContext()).fetchInfo()
