...
import com.starstudio.loser.phrapp.item.message.list.model.server.MilitaryServer;
...
public class MilitaryModel extends PHRModel implements CommonContract.Model {
    private CommonContract.Presenter mPresenter;

    public MilitaryModel(CommonContract.Presenter presenter) {
        this.mPresenter = presenter;
    }

    @Override
    public Observable<BaseBean> fetchModel(PHRFragment fragment) {
        return MilitaryServer.getInstance(fragment.getContext()).fetchInfo()
