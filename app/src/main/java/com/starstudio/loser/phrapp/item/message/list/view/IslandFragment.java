...
import com.starstudio.loser.phrapp.item.message.list.model.IslandModel;
...
public class IslandFragment extends PHRFragment<FragmentEventListener> implements CommonContract.View{
    ...
    public void initFragment(View view) {
        ...
        mPresenter.setModel(new IslandModel(mPresenter));
