...
import com.starstudio.loser.phrapp.item.message.list.model.SocialModel;
...
public class SocialFragment extends PHRFragment<FragmentEventListener> implements CommonContract.View{
    ...
    public void initFragment(View view) {
        ...
        mPresenter.setModel(new SocialModel(mPresenter));
