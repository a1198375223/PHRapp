...
import com.starstudio.loser.phrapp.item.message.list.model.FashionModel;
...
public class FashionFragment extends PHRFragment<FragmentEventListener> implements CommonContract.View{
    ...
    public void initFragment(View view) {
        ...
        mPresenter.setModel(new FashionModel(mPresenter));
