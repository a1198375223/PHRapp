...
import com.starstudio.loser.phrapp.item.message.list.model.TopModel;
...
public class TopFragment extends PHRFragment<FragmentEventListener> implements CommonContract.View{
    ...
    public void initFragment(View view) {
        ...
        mPresenter.setModel(new TopModel(mPresenter));
