...
import com.starstudio.loser.phrapp.item.message.list.model.MilitaryModel;
...
public class MilitaryFragment extends PHRFragment<FragmentEventListener> implements CommonContract.View{
    ...
    public void initFragment(View view) {
        ...
        mPresenter.setModel(new MilitaryModel(mPresenter));
