...
import com.starstudio.loser.phrapp.item.message.list.model.server.EntertainmentServer;
...
public class EntertainmentModel extends PHRModel implements CommonContract.Model {
    private CommonContract.Presenter mPresenter;

    public EntertainmentModel(CommonContract.Presenter presenter) {
        this.mPresenter = presenter;
    }

    @Override
    public Observable<BaseBean> fetchModel(PHRFragment fragment) {
        return EntertainmentServer.getInstance(fragment.getContext()).fetchInfo()
