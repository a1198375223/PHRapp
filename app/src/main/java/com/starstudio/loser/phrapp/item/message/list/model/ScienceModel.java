...
import com.starstudio.loser.phrapp.item.message.list.model.server.ScienceServer;
...
public class ScienceModel extends PHRModel implements CommonContract.Model {
    private CommonContract.Presenter mPresenter;

    public ScienceModel(CommonContract.Presenter presenter) {
        this.mPresenter = presenter;
    }

    @Override
    public Observable<BaseBean> fetchModel(PHRFragment fragment) {
        return ScienceServer.getInstance(fragment.getContext()).fetchInfo()
