...
public class DoctorRegisterActivity extends AppCompatActivity {
    ...
    private EditText username,phone,pwd,rpt_pwd,email,hospital,title,dept;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.phr_activity_doctor_register);
        initView();
        signUp();
    }
    ...
    private void initView(){
        ...
        hospital = (EditText) findViewById(R.id.phr_register_hospital);
        title = (EditText) findViewById(R.id.phr_register_title);
        dept = (EditText) findViewById(R.id.phr_register_department);
        ...
        sexGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                Toast.makeText(DoctorRegisterActivity.this,"性别"+sex,Toast.LENGTH_SHORT).show();
            }
        });
        ...
        sign_up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (password.equals("")||phoneNumber.equals("")||name.equals("")||mail.equals("")){
                    Toast toast = Toast.makeText(DoctorRegisterActivity.this, "请输入所有字段！", Toast.LENGTH_SHORT);
                    toast.setGravity(Gravity.CENTER, 0, 0);
                    toast.show();
                }else {
                    if (!password.equals(rpt_password)) {
                        Toast toast = Toast.makeText(DoctorRegisterActivity.this, "请确认两次密码一致！", Toast.LENGTH_SHORT);
                        toast.setGravity(Gravity.CENTER, 0, 0);
                        toast.show();
                    } else {
                        ...
                        user.put("sex", sex);
                        user.put("hospName",hospital.getText().toString());
                        ...
                        user.signUpInBackground(new SignUpCallback() {
                            ...
                            public void done(AVException e) {
                                if (e == null) {
                                    ...
                                    Intent intent = new Intent(DoctorRegisterActivity.this, PHRMainActivity.class);
                                    intent.putExtras(b);
                                    ...
                                    if (e.getCode()==0){
                                        Toast toast = Toast.makeText(DoctorRegisterActivity.this, "无法连接到服务器！", Toast.LENGTH_SHORT);
                                        toast.setGravity(Gravity.CENTER, 0, 0);
                                        toast.show();
                                    }else if (e.getCode()==202){
                                        Toast toast = Toast.makeText(DoctorRegisterActivity.this, "该用户名已注册！", Toast.LENGTH_SHORT);
                                        toast.setGravity(Gravity.CENTER, 0, 0);
                                        toast.show();
                                    }else if (e.getCode()==125){
                                        Toast toast = Toast.makeText(DoctorRegisterActivity.this, "请输入正确的邮箱格式！", Toast.LENGTH_SHORT);
                                        toast.setGravity(Gravity.CENTER, 0, 0);
                                        toast.show();
                                    }else if (e.getCode()==127){
                                        Toast toast = Toast.makeText(DoctorRegisterActivity.this, "手机号无效！", Toast.LENGTH_SHORT);
                                        toast.setGravity(Gravity.CENTER, 0, 0);
                                        toast.show();
                                    }else if (e.getCode() == 203){
                                        Toast toast = Toast.makeText(DoctorRegisterActivity.this, "该邮箱已注册！", Toast.LENGTH_SHORT);
                                        toast.setGravity(Gravity.CENTER, 0, 0);
                                        toast.show();
                                    }else if (e.getCode() == 214){
                                        Toast toast = Toast.makeText(DoctorRegisterActivity.this, "该手机号已注册！", Toast.LENGTH_SHORT);
                                        toast.setGravity(Gravity.CENTER, 0, 0);
                                        toast.show();
                                    }else if (e.getCode() == 217){
                                        Toast toast = Toast.makeText(DoctorRegisterActivity.this, "用户名不能有空格！", Toast.LENGTH_SHORT);
                                        toast.setGravity(Gravity.CENTER, 0, 0);
                                        toast.show();
                                    }
                                }
