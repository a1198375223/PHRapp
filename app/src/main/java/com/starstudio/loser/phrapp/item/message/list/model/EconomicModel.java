...
import com.starstudio.loser.phrapp.item.message.list.model.server.EconomicServer;
...
public class EconomicModel extends PHRModel implements CommonContract.Model {
    private CommonContract.Presenter mPresenter;

    public EconomicModel(CommonContract.Presenter presenter) {
        this.mPresenter = presenter;
    }

    @Override
    public Observable<BaseBean> fetchModel(PHRFragment fragment) {
        return EconomicServer.getInstance(fragment.getContext()).fetchInfo()
